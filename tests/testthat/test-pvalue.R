test_that("pvalue() returns correct two-sided p-values.", {
  ...
  expect_equal(
    pvalue(rnorm(1e7, mean = qnorm(0.95))),
    0.05 * 2,
    tolerance = 0.01
  )
  expect_equal(
    pvalue(rnorm(1e7, mean = qnorm(0.05))),
    0.05 * 2,
    tolerance = 0.01
  )
...
test_that("pvalue() returns the correct one-sided p-values", {
  ...
  expect_equal(
    pvalue(c(rep(-1, 25), rep(1, 1000 - 25)), side = "left"),
    25 / 1000
  )
  expect_equal(
    pvalue(c(rep(-1, 24), rep(1, 1000 - 24)), side = "left"),
    24 / 1000
  )
  ...
  expect_equal(
    pvalue(c(rep(-1, 25), rep(1, 1000 - 25)), side = "right"),
    975 / 1000
  )
  expect_equal(
    pvalue(c(rep(-1, 24), rep(1, 1000 - 24)), side = "right"),
    976 / 1000
  )
  ...
  expect_equal(
    pvalue(x = rnorm(1e7, mean = qnorm(0.95)), side = "left"),
    0.05,
    tolerance = 0.01
  )
  expect_equal(
    pvalue(x = rnorm(1e7, mean = qnorm(0.95)), side = "right"),
    0.95,
    tolerance = 0.01
  )

  expect_equal(
    pvalue(x = rcauchy(1e7, location = qcauchy(0.95)), side = "left"),
    0.05,
    tolerance = 0.01
  )
  expect_equal(
    pvalue(x = rcauchy(1e7, location = qcauchy(0.95)), side = "right"),
    0.95,
    tolerance = 0.01
  )
  ...
  expect_equal(
    pvalue(x = rpois(1e7, lambda = 3)),
    dpois(0, 3),
    tolerance = 0.01
  )
  expect_equal(
    pvalue(x = rpois(1e7, lambda = 3), side = "left"),
    dpois(0, 3),
    tolerance = 0.01
  )
  expect_equal(
    pvalue(x = rpois(1e7, lambda = 3), side = "right"),
    1,
    tolerance = 0.01
  )
  expect_equal(
  ...
  expect_equal(
    ...
    ppois(
      qpois(0.05, 3) - 1, # correct for boundary inclusion
      3,
      lower.tail = FALSE
    ),
    tolerance = 0.01
