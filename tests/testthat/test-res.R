...
test_that("res_gamma_pois_zi", {
  ...
  expect_identical(res_gamma_pois_zi(1, 1, 0, 0.5), 0)
  expect_identical(res_gamma_pois_zi(1, 1, 0, 0.5, type = "raw"), 0.5)
  expect_identical(res_gamma_pois_zi(1, 1, 0, 1), 0)
  expect_identical(res_gamma_pois_zi(1, 1, 0, 1, type = "raw"), 1)
  ...
  expect_equal(res_gamma_pois_zi(1:2, 2, 2, 0.5, simulate = TRUE), c(0.699911676381084, -0.80437196763369))
  set.seed(101)
  expect_identical(res_gamma_pois_zi(1:2, 2, 2, simulate = TRUE, type = "raw"), c(-1, 2))
