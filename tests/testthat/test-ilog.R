...
test_that("ilog vectorized inputs return expected output", {
  expect_equal(ilog(-10:10),
               c(4.53999297624849e-05, 0.00012340980408668, 0.000335462627902512,
  ...
  expect_equal(ilog(seq(-2, 2, length.out = 10)),
               c(0.135335283236613, 0.21107208779109, 0.329192987807906, 0.513417119032592,
...
test_that("ilog matrix inputs return expected output", {
  expect_equal(ilog(matrix(1:10, ncol = 2, nrow = 5)),
               structure(c(2.71828182845905, 7.38905609893065, 20.0855369231877,
                           54.5981500331442, 148.413159102577, 403.428793492735, 1096.63315842846,
                           2980.95798704173, 8103.08392757538, 22026.4657948067),
                         dim = c(5L, 2L)))
  expect_equal(ilog(matrix(seq(-2, 2, length.out = 10), nrow = 2, ncol = 5)),
               structure(c(0.135335283236613, 0.21107208779109, 0.329192987807906,
...
test_that("ilog array inputs return expected output", {
  expect_equal(ilog(array(1:20, dim = c(5, 2, 2))),
               structure(structure(c(2.71828182845905, 7.38905609893065, 20.0855369231877,
                                     54.5981500331442, 148.413159102577, 403.428793492735, 1096.63315842846,
                                     ...
                                     485165195.40979), dim = c(5L, 2L, 2L))))
  expect_equal(ilog(array(seq(-2, 2, length.out = 20), dim = c(2, 5, 2))),
               structure(c(0.135335283236613, 0.167048066569284, 0.206192028251409,
                           ...
                           7.38905609893065), dim = c(2L, 5L, 2L)))
})

test_that("ilog dataframe inputs return expected output", {
  expect_equal(ilog(data.frame(y = -5:5)),
               structure(list(y = c(0.00673794699908547, 0.0183156388887342,
                                    ...
                                    148.413159102577)), row.names = c(NA, -11L), class = "data.frame"))
})
