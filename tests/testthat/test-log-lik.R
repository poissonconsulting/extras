...
test_that("log_lik_beta truncated", {
  ...
  expect_equal(
    log_lik_beta(0.5, 2, 3, tlower = 0.2, tupper = 0.8),
    0.638658995275876
  )
  expect_equal(
    log_lik_beta(c(0.5, 0.9), 2, 3, tlower = 0.2, tupper = 0.8),
    c(0.638658995275876, -Inf)
  )
  expect_equal(
    log_lik_beta(c(0.2, 0.8), 2, 3, tlower = 0.2, tupper = 0.8),
    c(0.662375521893192, -0.723918839226699)
  )
  expect_equal(
    log_lik_beta(0.5, 2, 3, tlower = 0, tupper = 1),
    log_lik_beta(0.5, 2, 3)
  )
})
...
test_that("log_lik_binom truncated", {
  ...
  expect_equal(
    log_lik_binom(4, 10, 0.5, tlower = 2, tupper = 7),
    -1.51669586073549
  )
  expect_equal(
    log_lik_binom(c(4, 10), 10, 0.5, tlower = 2, tupper = 7),
    c(-1.51669586073549, -Inf)
  )
  expect_equal(
    log_lik_binom(c(2, 7), 10, 0.5, tlower = 2, tupper = 7),
    c(-3.05714090168264, -2.07631164867091)
  )
  expect_equal(
    log_lik_binom(c(1, 8), 10, 0.5, tlower = 2, tupper = 7),
    rep(-Inf, 2)
  )
  expect_equal(
    log_lik_binom(c(1, 1), 10, 0.5, tlower = c(1, 2), tupper = 7),
    c(-4.57161340245925, -Inf)
  )
  expect_equal(
    log_lik_binom(1, 10, 0.4, tlower = 0),
    log_lik_binom(1, 10, 0.4, tlower = -1)
  )
})
...
test_that("log_lik_exp truncated", {
  ...
  expect_equal(
    log_lik_exp(c(1, 3), 2, tlower = 0.5, tupper = 2),
    c(-0.255783638497353, -Inf)
  )
  expect_equal(
    log_lik_exp(c(1, 1.5), c(2, 1), tlower = 0.5, tupper = 2),
    c(-0.255783638497353, -0.747517541074546)
  )
...
test_that("log_lik_pois truncated", {
  ...
  expect_equal(
    log_lik_pois(c(4, 10), 10, tlower = 2, tupper = 7),
    c(-2.45231786495658, -Inf)
  )
  expect_equal(
    log_lik_pois(c(2, 7), 10, tlower = 2, tupper = 7),
    c(-4.57258140115667, -0.891670116691908)
  )
  expect_equal(log_lik_pois(c(1, 8), 10, tlower = 2, tupper = 7), rep(-Inf, 2))
  expect_equal(
    log_lik_pois(c(1, 1), 10, tlower = c(1, 2), tupper = 7),
    c(-6.1840834330596, -Inf)
  )
  expect_equal(
    log_lik_pois(1, 10, tlower = 0),
    log_lik_pois(1, 10, tlower = -1)
  )
})
...
test_that("log_lik_pois_zi", {
  ...
  expect_equal(
    log_lik_pois_zi(1, 10, 0.4, tlower = 0),
    log_lik_pois_zi(1, 10, 0.4, tlower = -1)
  )
})
...
test_that("log_lik_pois_zi truncated", {
  ...
  expect_error(
    log_lik_pois_zi(0, 1, 0.5, tlower = 1),
    "Specifying a lower truncation point greater than 0 doesn't make sense for a zero-inflated distribution."
  )
  expect_equal(
    log_lik_pois_zi(4L, 10, prob = 0.2, tupper = 7),
    -3.21316022478614
  )
  expect_equal(
    log_lik_pois_zi(4, 10, prob = 0.3, tupper = 7),
    -3.53507046752487
  )
  expect_equal(
    log_lik_pois_zi(c(4, 10), prob = 0.5, 10, tupper = 7),
    c(-4.16674515863436, -Inf)
  )
  expect_equal(
    log_lik_pois_zi(c(2, 7), prob = 0.5, 10, tupper = 7),
    c(-6.28700869483445, -2.60609741036969)
  )
  expect_equal(
    log_lik_pois_zi(c(1, 8), prob = 0.5, 10, tupper = 7),
    c(-7.89644660726855, -Inf)
  )
  expect_error(
    log_lik_pois_zi(c(1, 1), prob = 0.5, 10, tlower = c(1, 2), tupper = 7),
    "Specifying a lower truncation point greater than 0 doesn't make sense for a zero-inflated distribution."
  )
  expect_equal(
    log_lik_pois_zi(2, prob = c(0.5, 0.1), 10, tupper = c(7, 10)),
    c(-6.28700869483445, -5.72291103187376)
  )
  expect_equal(
    log_lik_pois_zi(1, 10, prob = 0.5, tlower = 0),
    log_lik_pois_zi(1, prob = 0.5, 10, tlower = -1)
  )
})
...
test_that("log_lik_norm truncated", {
  ...
  expect_equal(
    log_lik_norm(10, 10, 1, tlower = 0, tupper = 10),
    -0.225791352644727
  )
  expect_equal(
    log_lik_norm(c(10, 2), 10, 1, tlower = 0, tupper = 10),
    c(-0.225791352644727, -32.2257913526447)
  )
  expect_equal(
    log_lik_norm(c(10, 2), c(10, 3), 1, tlower = 0, tupper = 10),
    c(-0.225791352644727, -1.41758772323864)
  )
  expect_equal(
    log_lik_norm(c(10, 2), c(10, 3), c(1, 2), tlower = 0, tupper = 10),
    c(-0.225791352644727, -1.66769294409916)
  )
  expect_equal(
    log_lik_norm(c(10, 2), c(10, 3), c(1, 2), tlower = c(0, 1), tupper = 10),
    c(-0.225791352644727, -1.56405539976945)
  )
  expect_equal(
    log_lik_norm(
      c(10, 2),
    ...
    c(-0.225791352644727, -1.56432789634906)
  )
})
...
test_that("log_lik_lnorm truncated", {
  ...
  expect_equal(
    log_lik_lnorm(10, 10, 1, tlower = 0, tupper = 10),
    -0.24548202100403
  )
  expect_equal(
    log_lik_lnorm(c(10, 2), 10, 1, tlower = 0, tupper = 10),
    c(-0.24548202100403, -12.3197006846308)
  )
  expect_equal(
    log_lik_lnorm(c(10, 2), c(10, 3), 1, tlower = 0, tupper = 10),
    c(-0.24548202100403, -2.85723643248397)
  )
  expect_equal(
    log_lik_lnorm(c(10, 2), c(10, 3), c(1, 2), tlower = 0, tupper = 10),
    c(-0.24548202100403, -1.95887802625377)
  )
  expect_equal(
    log_lik_lnorm(c(10, 2), c(10, 3), c(1, 2), tlower = c(0, 1), tupper = 10),
    c(-0.24548202100403, -1.75589163000754)
  )
  expect_equal(
    log_lik_lnorm(
      c(10, 2),
    ...
    c(-0.24548202100403, -1.86651640350366)
  )
})
...
test_that("log_lik_neg_binom truncated", {
  ...
  expect_equal(
    log_lik_neg_binom(4, 10, 0.2, tlower = 2, tupper = 7),
    -1.81845034206372
  )
  expect_equal(
    log_lik_neg_binom(c(4, 10), 10, 0.2, tlower = 2, tupper = 7),
    c(-1.81845034206372, -Inf)
  )
  expect_equal(
    log_lik_neg_binom(c(2, 7), 10, 0.2, tlower = 2, tupper = 7),
    c(-2.54796516679454, -1.48424825397705)
  )
  expect_equal(
    log_lik_neg_binom(c(1, 8), 10, 0.2, tlower = 2, tupper = 7),
    rep(-Inf, 2)
  )
  expect_equal(
    log_lik_neg_binom(c(1, 1), 10, 0.2, tlower = c(1, 2), tupper = 7),
    c(-3.27948689055305, -Inf)
  )
  expect_equal(
    log_lik_neg_binom(1, 10, 0.2, tlower = 0),
    log_lik_neg_binom(1, 10, 0.2, tlower = -1)
  )
})
...
test_that("log_lik_gamma_pois truncated", {
  ...
  expect_equal(
    log_lik_gamma_pois(4, 10, 0.5, tlower = 2, tupper = 7),
    -1.74434428526587
  )
  expect_equal(
    log_lik_gamma_pois(c(4, 10), 10, 0.5, tlower = 2, tupper = 7),
    c(-1.74434428526587, -Inf)
  )
  expect_equal(
    log_lik_gamma_pois(c(2, 7), 10, 0.5, tlower = 2, tupper = 7),
    c(-1.89052679544395, -1.82130532640199)
  )
  expect_equal(
    log_lik_gamma_pois(c(1, 8), 10, 0.5, tlower = 2, tupper = 7),
    rep(-Inf, 2)
  )
  expect_equal(
    log_lik_gamma_pois(c(1, 1), 10, 0.5, tlower = c(1, 2), tupper = 7),
    c(-2.22770752806138, -Inf)
  )
  expect_equal(
    log_lik_gamma_pois(1, 10, 0.5, tlower = 0),
    log_lik_gamma_pois(1, 10, 0.5, tlower = -1)
  )
})
...
test_that("log_lik_gamma_pois_zi truncated", {
  ...
  expect_identical(
    log_lik_gamma_pois_zi(1, prob = 0.5, tlower = numeric(0)),
    numeric(0)
  )
  expect_identical(
    log_lik_gamma_pois_zi(1, prob = 0.5, tupper = numeric(0)),
    numeric(0)
  )
  expect_error(
  ...
  expect_equal(
    log_lik_gamma_pois_zi(4L, 10, 0.5, prob = 0.2, tupper = 7),
    -2.35712518489952
  )
  expect_equal(
    log_lik_gamma_pois_zi(4, 10, 0.5, prob = 0.3, tupper = 7),
    -2.58223035344082
  )
  expect_equal(
    log_lik_gamma_pois_zi(c(4, 10), 10, 0.5, prob = 0.3, tupper = 7),
    c(-2.58223035344082, -Inf)
  )
  expect_equal(
    log_lik_gamma_pois_zi(c(0, 7), 10, 0.5, prob = 0.3, tupper = 7),
    c(-0.663360059391162, -2.65919139457695)
  )
  expect_equal(
    log_lik_gamma_pois_zi(c(1, 8), 10, 0.5, prob = 0.3, tupper = 7),
    c(-2.95155641493311, -Inf)
  )
  expect_equal(
    log_lik_gamma_pois_zi(2, 10, 0.5, prob = c(0.3, 0.1), tupper = c(7, 10)),
    c(-2.7284128636189, -2.53453552706736)
  )
  expect_equal(
    log_lik_gamma_pois_zi(1, 10, 0.5, 0.3, tlower = 0),
    log_lik_gamma_pois_zi(1, 10, 0.5, 0.3, tlower = -1)
  )
})
...
test_that("log_lik_gamma truncated", {
  ...
  expect_equal(
    log_lik_gamma(1, 2, 2, tlower = 0.5, tupper = 2),
    -0.173929617921638
  )
  expect_equal(
    log_lik_gamma(c(1, 3), 2, 2, tlower = 0.5, tupper = 2),
    c(-0.173929617921638, -Inf)
  )
  expect_equal(
    log_lik_gamma(c(1, 2), 2, 2, tlower = 0.5, tupper = 1.5),
    c(0.00877693176656302, -Inf)
  )
  expect_equal(
    log_lik_gamma(c(1, 2), c(2, 3), 2, tlower = 0.5, tupper = 2),
    c(-0.173929617921638, -0.844092074878338)
  )
  expect_equal(
    log_lik_gamma(c(1, 2), c(2, 3), c(2, 1), tlower = 0.5, tupper = 2),
    c(-0.173929617921638, -0.132231371406472)
  )
  expect_equal(
    log_lik_gamma(c(1, 2), c(2, 3), c(2, 1), tlower = c(0.5, 1.5), tupper = 2),
    c(-0.173929617921638, 0.71681035176181)
  )
  expect_equal(
    log_lik_gamma(
      c(1, 2),
    ...
    c(-0.173929617921638, -0.354045264075196)
  )
  expect_equal(
    log_lik_gamma(1, 2, 2, tlower = 0),
    log_lik_gamma(1, 2, 2, tlower = -1)
  )
})
...
test_that("log_lik_student truncated", {
  ...
  expect_equal(
    log_lik_student(2, 2, 1, 0.5, tlower = 0, tupper = 3),
    -0.678641032965461
  )
  expect_equal(
    log_lik_student(c(2, 5), 2, 1, 0.5, tlower = 0, tupper = 3),
    c(-0.678641032965461, -Inf)
  )
  expect_equal(
    log_lik_student(c(0, 3), 2, 1, 0.5, tlower = 0, tupper = 3),
    c(-2.32655946596763, -1.28683869512771)
  )
  expect_equal(
    log_lik_student(c(2, 1), c(2, 3), 1, 0.5, tlower = 0, tupper = 3),
    c(-0.678641032965461, -1.89415667555106)
  )
  expect_equal(
    log_lik_student(c(2, 1), c(2, 3), c(1, 2), 0.5, tlower = 0, tupper = 3),
    c(-0.678641032965461, -1.32992404964217)
  )
  expect_equal(
    log_lik_student(
      c(2, 1),
    ...
    c(-0.678641032965461, -1.09861228866811)
  )
  expect_equal(
    log_lik_student(
      c(2, 1),
    ...
    c(-0.678641032965461, -1.55435868307644)
  )
})
...
test_that("log_lik_beta_binom truncated", {
  ...
  expect_identical(
    log_lik_beta_binom(1, 3, 0.5, 0.5, tlower = numeric(0)),
    numeric(0)
  )
  expect_identical(
    log_lik_beta_binom(1, 3, 0.5, 0.5, tupper = numeric(0)),
    numeric(0)
  )
  ...
  expect_equal(
    log_lik_beta_binom(4, 10, 0.5, 0.5, tlower = 2),
    -1.98591548366901
  )
  expect_equal(
    log_lik_beta_binom(4, 10, 0.5, 0.5, tupper = 7),
    -1.87399756746503
  )
  expect_equal(
    log_lik_beta_binom(4, 10, 0.5, 0.5, tlower = 2, tupper = 7),
    -1.72785566724858
  )
  expect_equal(
    log_lik_beta_binom(c(4, 10), 10, 0.5, 0.5, tlower = 2, tupper = 7),
    c(-1.72785566724858, -Inf)
  )
  expect_equal(
    log_lik_beta_binom(c(2, 7), 10, 0.5, 0.5, tlower = 2, tupper = 7),
    c(-1.98736686273366, -1.81746782593826)
  )
  expect_equal(
    log_lik_beta_binom(c(1, 8), 10, 0.5, 0.5, tlower = 2, tupper = 7),
    rep(-Inf, 2)
  )
  expect_equal(
    log_lik_beta_binom(c(1, 1), 10, 0.5, 0.5, tlower = c(1, 2), tupper = 7),
    c(-2.38416507998647, -Inf)
  )
})
...
test_that("log_lik_skewnorm truncated", {
  ...
  expect_equal(
    log_lik_skewnorm(2, 2, 1, 2, tlower = 0, tupper = 3),
    -0.539737569579466
  )
  expect_equal(
    log_lik_skewnorm(c(2, 5), 2, 1, 2, tlower = 0, tupper = 3),
    c(-0.539737569579466, -Inf)
  )
  expect_equal(
    log_lik_skewnorm(c(0, 3), 2, 1, 2, tlower = 0, tupper = 3),
    c(-12.2066918755468, -0.369603298348484)
  )
  expect_equal(
    log_lik_skewnorm(c(2, 1), c(2, 3), 1, 2, tlower = 0, tupper = 3),
    c(-0.539737569579466, -10.6725324746642)
  )
  expect_equal(
    log_lik_skewnorm(c(2, 1), c(2, 3), c(1, 2), 2, tlower = 0, tupper = 3),
    c(-0.539737569579466, -3.2884866170158)
  )
  expect_equal(
    log_lik_skewnorm(
      c(2, 1),
    ...
    c(-0.539737569579466, -1.11502460663457)
  )
  expect_equal(
    log_lik_skewnorm(2, 2, 1, 0, tlower = 0, tupper = 3),
    log_lik_norm(2, 2, 1, tlower = 0, tupper = 3)
  )
})
...
test_that("log_lik_skewlnorm equal to log_lik_lnorm when shape = 0", {
  skip_if_not_installed("sn")
  expect_equal(
    log_lik_skewlnorm(1:5, 0.3, 0.7, 0),
    log_lik_lnorm(1:5, 0.3, 0.7)
  )
})
...
test_that("log_lik_skewlnorm truncated", {
  ...
  expect_equal(
    log_lik_skewlnorm(c(2, 5), 0, 1, 2, tlower = 0, tupper = 3),
    c(-0.929486834393317, -Inf)
  )
  expect_equal(
