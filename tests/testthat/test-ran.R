...
test_that("ran_gamma_pois", {
  ...
  expect_identical(ran_gamma_pois(2), c(0L, 1L))
  expect_identical(ran_gamma_pois(2, 10), c(11L, 8L))
  expect_identical(ran_gamma_pois(2, c(0.1,100)), c(0L, 103L))
  expect_identical(ran_gamma_pois(1, c(0.1,100)), 0L)
  set.seed(101)
  expect_identical(ran_gamma_pois(theta = 10), 1L)
  expect_identical(ran_gamma_pois(2, theta = 10), c(2L, 1L))
  expect_identical(ran_gamma_pois(2, 10, theta = 10), c(8L, 11L))
  expect_identical(ran_gamma_pois(2, c(0.1,100), theta = 100), c(0L, 88L))
  expect_identical(ran_gamma_pois(1, c(0.1,100), theta = 100), 0L)
})
