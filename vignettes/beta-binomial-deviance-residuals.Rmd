...
The expected value used to calculate the sign of the residual ($n \cdot p^*$) tends to be greater than the true expected value ($n \cdot p$) due to the shape of the likelihood function shown in Figure 1; this difference increases with $\theta$. The simulated $x$ values still have a mean of $n \cdot p$.
Thus, the value of $x_i$ is likely to be smaller than its associated expected value $n \cdot p_i^*$, which explains the higher density of deviance residuals $< 0$ in Figure 4 for $\theta > 0$.
