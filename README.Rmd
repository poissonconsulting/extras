...
In particular it provides functions to summarise MCMC samples
and R translations of `BUGS` (and `JAGS`) functions.
...
The package also provides R translations of `BUGS` (and `JAGS`) functions such as `log<-` and `logit<-`.
